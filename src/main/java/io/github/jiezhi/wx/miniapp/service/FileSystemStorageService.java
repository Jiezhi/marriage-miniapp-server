package io.github.jiezhi.wx.miniapp.service;
    ...
    public void store(MultipartFile file) {
        ...
        try {
            ...
            if (filename.contains("..")) {
                throw new StorageException("Cannot store file with relative path outside current directroy " + filename);
            }
